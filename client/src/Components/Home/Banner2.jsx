...
const Banner2 = () => {
  return (
	...
	{/* <div className="banner padding-top padding-bottom bg_img" style={{backgroundImage: "url(assets5/images/banner/bg.jpg)"}}> */}
	<div className="banner padding-top padding-bottom bg_img" style={{background: "assets5/images/banner/bg.jpg"}}>
			...
			<div className="row justify-content-center">
						...
						<div className="banner__form">
							<form action="#">
								<div className="banner__list">
									...
									<div className="row">
										<div className="col-6">
											<label className="banner__inputlist" for="male">
												<input type="radio" id="male" name="me" className="male" checked=""/>
												<span>Male</span>
												<span className="banner__inputlist--icon"><i className="fa-solid fa-mars"></i></span>
											</label>
										</div>
										<div className="col-6">
											<label className="banner__inputlist" for="female">
								...
								<div className="banner__list">
									...
									<div className="row">
										<div className="col-6">
											<label className="banner__inputlist" for="male2">
										...
										<div className="col-6">
											<label className="banner__inputlist" for="female2">
												<input type="radio" id="female2" name="me2" className="female" checked=""/>
												<span>Female</span>
												<span className="banner__inputlist--icon"><i className="fa-solid fa-venus"></i></span>
											</label>
										</div>
				...
				<div className="col-lg-6 col-12">
					<div className="banner__thumb banner__thumb--thumb1 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1s">
						<img src="assets5/images/banner/01.png" alt="banner"/>
					</div>
				</div>
			</div>
		</div>
